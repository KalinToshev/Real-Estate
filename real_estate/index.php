...
<body>
   ...
   <!-- Изчисляване и задаване на размери за височината на всяка кутия от секцията "Какво правим ние" за по-добър изглед на кутиите. Височината се определя спрямо кутията с най-много информация в нея и се прибавят още 20 пиксела. -->
   <script>
